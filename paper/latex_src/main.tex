...
\begin{itemize}[noitemsep]
  \item WLS (HC3) slope: \(\hat\beta_1 \approx -0.236\) per unit math\_ratio (≈ \(-0.00236\) per percentage point), 95\% CI \([-0.271,-0.202]\).
  \item Bootstrap (5,000 resamples): median slope ≈ \(-0.2367\), 95\% CI \([-0.2639,-0.1963]\).
  \item Permutation test (5,000 permutations): observed slope = \(-0.2363\), \(p_{\text{perm}}\approx 0.0002\).
  \item Mixed‑effects model (random intercept): slope ≈ \(-0.273\).
\end{itemize}
