...
- Seed-level summary CSV: **D:\guardian_project\experiments\ablation_summary.csv**

- Output folder: **D:\guardian_project\experiments\plots**
...
MixedLM summary saved to: **plots/mixedlm_summary.txt**
...
- plots/aggregated_by_model_ratio.csv

- plots/agg_regression_plot.png

- plots/regression_bestf1_vs_mathratio.json

- plots/bootstrap_slope_ci.json

- plots/cooks_distance.csv

- plots/mixedlm_summary.txt

- plots/mixedlm_result.json
