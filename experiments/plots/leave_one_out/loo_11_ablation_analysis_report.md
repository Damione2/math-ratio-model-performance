...
- Seed-level summary CSV: **D:\guardian_project\experiments\plots\leave_one_out\ablation_summary_loo_drop_11_Qwen2.5-Math-1.5B_math_0.356431292118.csv**
...
{
  "slope": -0.001545746303109708,
  "intercept": 0.9590643793361497,
  "r_squared": 0.48156464631074536,
  "p_value": 0.017844874463514696,
  "stderr": 0.0005346098652701598,
  "n": 11
}
...
{
  "median": -0.0015843926781299372,
  "ci_lower": -0.004990302146491283,
  "ci_upper": 5.693029551566856e-05,
  "n_boot": 500
}
...
MixedLM summary saved to: **leave_one_out/loo_11_mixedlm_summary.txt**
...
{
  "fixed_effect_math_pct_coef": -0.002728487173957793,
  "fixed_effect_math_pct_se": 9.919295297151109e-05,
  "pvalue": 1.453199938985579e-166,
  "converged": true
}
...
- leave_one_out/loo_11_aggregated_by_model_ratio.csv

- leave_one_out/loo_11_agg_regression_plot.png

- leave_one_out/loo_11_regression_bestf1_vs_mathratio.json

- leave_one_out/loo_11_bootstrap_slope_ci.json

- leave_one_out/loo_11_cooks_distance.csv

- leave_one_out/loo_11_mixedlm_summary.txt

- leave_one_out/loo_11_mixedlm_result.json
